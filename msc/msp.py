...
class MSPStatus(Enum):
    ...
    #  音频截幅(因信号波形的幅度太大，而超出系统的线性范围)，如记录尖叫声的音频
    ...
    # !Invalid iSampa format or input iSampa text contain invalid alphabet*/
    SPEECH_ERROR_AISOUND_INVALID_CSSML = 24114
    # /* !Invalid cssml format */
...
def MSPRegisterNotify(statusCb: CFuncPtr, userData: bytes):
